...
def get_stock_quarterly_roe(symbol: str):
    ...
    Returns:
        dict: {
            ...
            "period_type": "quarterly",                             # ROE is reported on an quarterly basis
            ...
            "data": list[dict],                                     # List of records with:
                ...
                - net_income_common_stockholders (decimal | None):  # Net income attributable to common stockholders
                - beginning_stockholders_equity (decimal | None):   # Stockholders' equity at the beginning of the period (i.e., prior period ending equity)
                - ending_stockholders_equity (decimal | None):      # Stockholders' equity at the end of the current period
                - avg_equity (decimal | None):                      # Average stockholders' equity = (beginning_stockholders_equity + ending_stockholders_equity) / 2
                - roe (decimal | None):                             # Return on Equity = net_income_common_stockholders / avg_equity
        }
